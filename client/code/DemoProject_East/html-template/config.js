var config = {
	...
	pocicy : "http://res.action.yuuhhe.com/crossdomain.xml",
...
var heroFactory = {	
	_heros : [
		...
		{id:98, name:"关羽", skill:4, face:2, body:2, unit:2},
		{id:225, name:"司马懿", skill:2, face:4, body:4, unit:4},
		{id:343, name:"曹操", skill:1, face:1, body:1, unit:1},
		{id:432, name:"张飞", skill:5, face:3, body:3, unit:3},
		{id:660, name:"吕布", skill:3, face:5, body:5, unit:5},
