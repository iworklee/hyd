...
var heroFactory = {	
	_heros : [
		...
		{id:395, name:"赵云", skill:6, face:6, body:6, unit:6},
		{id:370, name:"孙策", skill:7, face:7, body:7, unit:7},
		{id:289, name:"诸葛亮", skill:8, face:8, body:8, unit:8},
		{id:245, name:"周瑜", skill:9, face:9, body:9, unit:9},
		{id:424, name:"貂禅", skill:10, face:10, body:10, unit:10},
...
var skillFactory = {
	_skills : [
		...
		{id:8, name:"奇门遁甲", type:3, resPrevious:0, resCurrent:5, resPost:0},
		{id:9, name:"炼狱火海", type:2, resPrevious:0, resCurrent:1, resPost:0},
		{id:10, name:"倾国倾城", type:2, resPrevious:0, resCurrent:3, resPost:0}
	],
