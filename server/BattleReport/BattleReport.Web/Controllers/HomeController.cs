...
namespace BattleReport.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(WarModel model)
        {
            ...
            defender.Units.Add(new Unit { ID = 2, Positon = 0 });
            defender.Units.Add(new Unit { ID = 2, Positon = 1 });
            defender.Units.Add(new Unit { ID = 2, Positon = 2 });
            defender.Units.Add(new Unit { ID = 2, Positon = 3 });
            defender.Units.Add(new Unit { ID = 2, Positon = 4 });
            defender.Units.Add(new Unit { ID = 2, Positon = 5 });
            defender.Units.Add(new Unit { ID = 2, Positon = 6 });
            defender.Units.Add(new Unit { ID = 2, Positon = 7 });
            defender.Units.Add(new Unit { ID = 2, Positon = 8 });
            defender.Units.Add(new Unit { ID = 2, Positon = 9 });
            defender.Units.Add(new Unit { ID = 2, Positon = 10 });
            defender.Units.Add(new Unit { ID = 2, Positon = 11 });
            defender.Units.Add(new Unit { ID = 2, Positon = 12 });
            defender.Units.Add(new Unit { ID = 2, Positon = 13 });
            defender.Units.Add(new Unit { ID = 2, Positon = 14 });
            defender.Units.Add(new Unit { ID = 2, Positon = 15 });
            defender.Units.Add(new Unit { ID = 2, Positon = 16 });
            defender.Units.Add(new Unit { ID = 2, Positon = 17 });
            defender.Units.Add(new Unit { ID = 2, Positon = 18 });
            defender.Units.Add(new Unit { ID = 2, Positon = 19 });
            defender.Units.Add(new Unit { ID = 2, Positon = 20 });
            defender.Units.Add(new Unit { ID = 2, Positon = 21 });
            defender.Units.Add(new Unit { ID = 2, Positon = 22 });
            defender.Units.Add(new Unit { ID = 2, Positon = 23 });
            defender.Units.Add(new Unit { ID = 2, Positon = 24 });
