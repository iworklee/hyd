package Action.Model.Protobuf {
	...
	public dynamic final class BackdoorLoginArgs extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ACCOUNT:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("Action.Model.Protobuf.BackdoorLoginArgs.Account", "account", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
