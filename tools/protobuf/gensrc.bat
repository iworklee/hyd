...
rem for %%a in (protos\*.*) do protobuf-csharp-port\ProtoGen.exe -output_directory=C# %%a


:==================	generate AS3 source using protoc-gen-as3	================
for %%a in (protos\*.*) do protoc --plugin=protoc-gen-as3=protoc-gen-as3\protoc-gen-as3.bat --as3_out=AS3 %%a
